...
class Analytics:
    ...
    def query_activity(self, queries: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.client._make_request(
            "POST", "/v1/analytics/activity", json_data={"queries": queries}
        )
    ...
    def query_funnel(self, queries: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/analytics/funnel", json_data={"queries": queries}
        )
    ...
    def query_leads(self, queries: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/analytics/leads", json_data={"queries": queries}
        )
    ...
    def query_projects(self, queries: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/analytics/projects", json_data={"queries": queries}
        )
    ...
    def query_team_activity(self, queries: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/analytics/teamactivity", json_data={"queries": queries}
        )
    ...
    def get_team_activity_update(self) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request("GET", "/v1/analytics/teamactivity/update")
