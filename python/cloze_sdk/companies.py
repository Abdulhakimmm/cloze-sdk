...
class Companies:
    ...
    def create(self, company: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.client._make_request(
            "POST", "/v1/companies/create", json_data=company
        )
    ...
    def update(self, company: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/companies/update", json_data=company
        )
    ...
    def get(
        ...
        return self.client._make_request("GET", "/v1/companies/get", params=params)
    ...
    def delete(
        ...
        return self.client._make_request(
            "DELETE", "/v1/companies/delete", params=params
        )
    ...
    def find(
        ...
        **kwargs
        ...
        return self.client._make_request("GET", "/v1/companies/find", params=params)
    ...
    def feed(
        ...
        **kwargs
        ...
        return self.client._make_request("GET", "/v1/companies/feed", params=params)
