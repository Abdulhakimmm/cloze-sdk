...
class Projects:
    ...
    def create(self, project: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.client._make_request(
            "POST", "/v1/projects/create", json_data=project
        )
    ...
    def update(self, project: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self.client._make_request(
            "POST", "/v1/projects/update", json_data=project
        )
    ...
    def get(
        ...
        return self.client._make_request("GET", "/v1/projects/get", params=params)
    ...
    def delete(
        ...
        return self.client._make_request("DELETE", "/v1/projects/delete", params=params)
    ...
    def find(
        ...
        **kwargs
        ...
        return self.client._make_request("GET", "/v1/projects/find", params=params)
    ...
    def feed(
        ...
        **kwargs
        ...
        return self.client._make_request("GET", "/v1/projects/feed", params=params)
